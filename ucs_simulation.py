...
# friction interaction between particles
fip = RotFrictionPrms(
    "friction",
    pi*YoungsModulus/2.0,
    frictionCoeff,
    frictionCoeff,
    pi*ShearModulus/2.0
)
...
# add front and back walls in Z — geometry runs from Z=0 to Z≈130
